            ...
            <div className="flex flex-wrap justify-center px-5 sm:px-10 md:px-20 bg-birumuda min-h-screen font-main">
                <div className="w-full sm:w-4/5 md:w-1/2 lg:w-2/5 border-2 rounded-2xl px-6 bg-white my-10 sm:my-20 md:my-30 py-5">
                    ...
                    <form onSubmit={handleSubmit} className="mb-5">
                        <label
                            htmlFor="password"
                            className="block text-gray-700 text-sm font-bold mb-5"> Password Baru
                        </label>
                        <input
                            type="password"
                            name="password"
                            ...
                            className="border-2 mb-10 border-slate-200 rounded w-full py-2 px-3 text-gray-700 focus:outline-slate-500 focus:shadow-outline"
                            required
                        />
                        <div className="flex justify-center mb-5">
                            <button type="submit" className="bg-blue-500 text-white text-base rounded-lg py-2 px-4 hover:bg-birutua hover:scale-105 transition duration-200">KIRIM LINK</button>
                        </div>
                    </form>
                </div>
            </div>
