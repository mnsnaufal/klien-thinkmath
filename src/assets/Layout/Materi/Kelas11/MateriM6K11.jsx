    ...
    return (
        <div className='bg-blue-100 py-12 font-main'>
            ...
            <div className='py-5 px-5 mx-60 mt-20 justify-center rounded-3xl bg-pink-500 text-black'>
                ...
                <div className='bg-gray-100 px-5 py-3 rounded-2xl mb-3'>
                    <p className='font-semibold text-md text-center'>Grammar Intermediate mengacu pada tingkat keterampilan tata bahasa yang berada di antara pemula (beginner) dan lanjutan (advanced). Pada tingkat ini, pembelajar diharapkan memiliki pemahaman dasar yang baik tentang struktur bahasa dan mulai menguasai aturan tata bahasa yang lebih kompleks.</p>
                </div>
