...
export default function LatihanGramSulit() {
    ...
    const [timeLeft, setTimeLeft] = useState(1200); // Timer dalam detik
    ...
    //agar random
    useEffect(() => {
        const shuffledQuestions = shuffleArray([...DataLatGramSul]); // Acak soal
                    ...
                    {!result ? (
                        ...
                        <div className="text-center">
                            ...
                            <h1 className="mb-5 text-lg font-semibold">
                                You scored {score} out of {DataLatGramSul.length} questions
                            </h1>
