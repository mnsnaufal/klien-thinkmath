...
export default function LatihanGramMudah() {
    ...
    const [timeLeft, setTimeLeft] = useState(10); // Timer dalam detik
    ...
    //agar random
    useEffect(() => {
        const shuffledQuestions = shuffleArray([...DataLatGramMud]); // Acak soal
                    ...
                    {!result ? (
                        ...
                        <div className="text-center">
                            ...
                            <h1 className="mb-5 text-lg font-semibold">
                                You scored {score} out of {DataLatGramMud.length} questions
                            </h1>
