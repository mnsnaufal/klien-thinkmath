...
export default function KuisM1K10() {
    ...
    const data = {
        quizname : "Pertidaksamaan Linear Satu Variabel",
        score : score * 10,
        percobaan : 0,
        ...
        <>
            <div className="w-full flex items-center justify-center">
                <div className=" bg-white rounded-xl py-10 px-5 mx-10 justify-center lg:w-1/2 md:w-1/3 drop-shadow-2xl shadow-2xl">
                    ...
                    <div className=" text-center mb-10 mx-auto"><h3 className="font-medium text-lg mb-2">Kuis Kelas 8</h3>
                        <h1 className="font-bold text-3xl">Pertidaksamaan Linear Satu Variabel</h1>
                    </div>
                    {result ? <></> : <>
