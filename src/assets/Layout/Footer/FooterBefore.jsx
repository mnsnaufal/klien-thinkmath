...
export default function FooterBefore() {
    return (
        <>
            <footer className="bg-indigo-500 pt-24 pb-12">
                <div className="mx-10">
                    <div className="flex flex-wrap">
                        ...
                        <div className="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/3">
                            ...
                            <h1 className="font-bold text-5xl text-white">ENGLIX</h1>
                        </div>
                        ...
                        <div className="w-full px-4 mb-12 text-slate-300 font-medium text-lg md:w-1/3">
                            ...
                            <ul>
                                <li className="mb-2">
                                    <a href="#" className="text-slate-200 hover:text-pink-500">Home
                                    </a>
                                </li>
                                <li className="mb-2">
                                    <a href="" className="text-slate-200 hover:text-pink-500">Kenapa Englix
                                    </a>
                                </li>
                                <li className="mb-2">
                                    <a href="" className="text-slate-200 hover:text-pink-500">Tentang Kami
                                    </a>
                                </li>
                                <li className="mb-2">
                                    <a href="#" className="text-slate-200 hover:text-pink-500">Kontak Kami
                                    </a>
                                </li>
                                <li className="mb-2">
