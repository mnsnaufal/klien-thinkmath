...
export default function PilGanLatMenengah() {
    ...
    const [timeLeft, setTimeLeft] = useState(2400); // Timer dalam detik
    ...
    const data = {
        quizname: "Ujian Tingkat Menengah",
        score: score * 10,
        percobaan: 0,
    ...
    //agar random
    useEffect(() => {
        const shuffledQuestions = shuffleArray([...DataLatMenengah]); // Acak soal
                    ...
                    {!result ? (
                        ...
                        <div className="text-center">
                            ...
                            <h1 className="mb-5 text-lg font-semibold">
                                You scored {score} out of {DataLatMenengah.length} questions
                            </h1>
